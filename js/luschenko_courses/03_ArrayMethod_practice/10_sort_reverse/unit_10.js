...
const f2 = () => {
  document.querySelector('.out-2').textContent = s2.split('').reverse().join('')
}
...
const f6 = () => {
  document.querySelector('.out-6').textContent = a6.sort().join(' ')
}
...
const f8 = () => {
  document.querySelector('.out-8').textContent = a8.sort((a, b) => a - b).join(' ')
}
...
const f9 = (s) => {
  if (s === 'ASC') return a9.sort(asc)
  if (s === 'DESC') return a9.sort(desc)
}
...
const f10 = () => {
  let a10sorted = a10.sort((a, b) => {
    return a.age - b.age
  })

  document.querySelector('.out-10').textContent = a10sorted.reduce((acc, item) => {
