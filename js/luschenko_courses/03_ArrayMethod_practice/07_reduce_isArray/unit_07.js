...
const f2 = () => {
  ...
  document.querySelector('.out-2').textContent = isArray
}
...
const f7 = () => {
  let res = a7.reduce((accum, item) => (item > 0 ? accum + item : accum), 0)
...
const f9 = () => {
  let res = a9.reduce((accum, item) => (item > 0 ? accum * item : accum), 1)
...
const f14 = () => {
  ...
  document.querySelector('.out-14').textContent = res
}
...
const f17 = () => {
  ...
  let out = a17_res.reduce((accum, item) => {
    return accum + item + ' '
  }, '')
...
const f20 = () => {
  document.querySelector('.out-20').textContent = a20.reverse().join(' ')
}
