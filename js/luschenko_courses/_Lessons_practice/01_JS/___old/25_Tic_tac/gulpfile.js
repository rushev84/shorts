...
let path = {
  ...
  src: {
    ...
    js: [src_folder + '/js/index.js', src_folder + '/js/game.js'],
    // css: src_folder + '/scss/style.scss',
    css: [src_folder + '/scss/main.scss', src_folder + '/scss/vendor.scss'],
...
function html() {
  // return src(path.src.html, {}).pipe(plumber()).pipe(fileinclude()).pipe(webphtml()).pipe(dest(path.build.html)).pipe(browsersync.stream())
...
let build = gulp.series(
  clean,
  fonts_otf,
  gulp.parallel(html, css, js, favicon, images),
  fonts,
