...
document.querySelector('.b-1').addEventListener('click', function () {
  document.querySelector('.out-1').textContent = t1(1, 4)
})
...
const t2 = (num1, num2) => (num1 > num2 ? num1 : num2)

document.querySelector('.b-2').addEventListener('click', function () {
  document.querySelector('.out-2').textContent = t2(1, 5)
})
...
const t3 = (a, b, c) => (b !== 0 ? a / b : c)

document.querySelector('.b-3').addEventListener('click', function () {
  document.querySelector('.out-3').textContent = t3(8, 4, 555)
})
...
document.querySelector('.b-4').addEventListener('click', function () {
  t4([1, 2, 3, 4], document.querySelector('.out-4'))
})
...
const t5 = (className) => {
  if (document.getElementsByClassName(className.substr(1)).length !== 0) {
    return true
  } else {
    return false
  }
...
const t6 = (arr) => arr.reverse()

document.querySelector('.b-6').addEventListener('click', () => {
  document.querySelector('.out-6').textContent = t6([0, 1, 2, 3]).join(' ')
})
...
const block = document.querySelector('.out-7')
...
const t8 = (arr, year) => {
  for (let index in arr) {
    if (arr[index] < year) return false
  }
  return true
}
...
document.querySelector('.b-9').addEventListener('click', () => {
  document.querySelector('.out-9').textContent = t9([0, 1, 2, 3], 1845).join(' ')
})
...
document.querySelector('.b-10').addEventListener('click', () => {
  document.querySelector('.out-10').textContent = t10([0, 1, 2, 3], 1845, 1945).join(' ')
})
