...
<div class="container">
    ...
    <section>
        <p><b>Task 8.</b></p>
        <p>Создать функцию t8 которая принимает дату в unixtime и возвращает 1 если суббота или воскресенье и 0 в противном случае.</p>
        <?php
        echo '<pre>';
        echo(t8(1632662324));
        echo '</pre>';
    ...
    <section>
        <p><b>Task 10.</b></p>
        <p>Создать функцию t10, которая возвращает время в секундах прошедших с начала текущего года.</p>
        <?php
        echo '<pre>';
        echo(t10());
        echo '</pre>';
