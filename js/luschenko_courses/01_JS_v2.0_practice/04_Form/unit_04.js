...
// !!!!!!! Поясню, по какому правилу я создаю или не создаю переменные. Если в функции обращение к нужному узлу происходит несколько раз, то имеет смысл вынести этот узел в переменную вне функции. Если же обращение идёт только один раз, то querySelector делается прямо в функции в момент её выполнения.
...
function f8() {
  ...
  out8.innerHTML = '<input class="i-81" /><button class="b-81">Print value</button>'
...
//поиск элемента i-13 на странице идёт два раза, но строчка ниже была в задании, поэтому я не стал её менять
...
function f20(e) {
  ...
  out20.textContent = form.elements['username'].value + ' ' + form.elements['password'].value
}
