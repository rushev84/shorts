// В консоли возникает предупреждение по подключению библиотеки стилей:
// https://disk.yandex.ru/i/NKSF_Sg0HJzTfA
// 15 минут гугленья ситуацию не прояснили - возможно, у вас есть решение.
...
document.querySelector('.four').innerHTML += '<p>paragraph text</p>'
