...
let ar1 = ['Hello!', 'Hello, world!', 0, 1, true, false]
...
let ar2 = ['Hello!', 'Hello, world!', 0, 1, true, false]
...
let ar3 = ['Hello!', 'Hello, world!', 0, 1, true, false]
...
let ar4 = ['Hello!', 'Hello, world!', 0, 1, true, false, 'Goodbye!', 'Goodbye, world!', 'Ivan']
...
function f8() {
  ...
  for (let i = 0; i < ar8.length; i++) {
    out += ar8[i] + '-'
    // В условии задачи не оговорено, нужен ли дефис в конце. Если не нужен, его нетрудно убрать с помощью проверки элемента массива (является ли элемент последним)
  }
...
function f16() {
  ...
  for (let i = 0; i < ar16.length; i++) {
    if (ar16[i] % 2 === 0) {
      ar16_even[counters[0]++] = ar16[i]
    } else {
      ar16_odd[counters[1]++] = ar16[i]
    }
  }
