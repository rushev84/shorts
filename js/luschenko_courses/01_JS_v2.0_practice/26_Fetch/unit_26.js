...
function t2() {
  fetch('http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=2&name=Sergey')
    .then((response) => response.text())
    .then((response) => {
...
function t3() {
  fetch('http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=3&num1=2&num2=3')
    .then((response) => response.text())
    .then((response) => {
...
function t4() {
  fetch('http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=4&num1=0&num2=10')
    .then((response) => response.text())
    .then((response) => {
...
function t8() {
  fetch('http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=8&year=1984')
    .then((response) => response.text())
    .then((response) => {
